...
def home():
    ...
    auto_onoff = "False"  # "<input type='submit' value='{}' name='action4' />".format(enable_automatic_sprinkling)
    if mainClass.auto_sprinkling:
        auto_onoff = "True"  # "<input type='submit' value='{}' name='action4' />".format(disable_automatic_sprinkling)
